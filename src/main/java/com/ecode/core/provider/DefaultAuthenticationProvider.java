package com.ecode.core.provider;

import com.ecode.core.constant.UserLockStatus;
        ...
        try {
            ...
            if (_objLockUser != null) {
                ...
                if (_count <= 5) {
                    ...
                    _update.setString("status", UserLockStatus.PROCESSING);
...
//                  Update Status User Account ot account locked = true
                    if (length >= 5) {
                        ...
                        update_.setString("status", UserLockStatus.END);
                ...
                _save.setString("status", UserLockStatus.START);
